	...
	$.fn.inheritLock = function() {
		...
		$(this).bind('click', function() {
			...
			if ($(this).prop("checked")) {
				$("input[name^='" + codpat + "_']").each(function() {
		...
		<form name="form1" method="post">
			...
			<table border=1 cellpadding="2" cellspacing="0" bordercolor="#000000">
				<tbody>
					{if $centro!=""}
					<tr>
						<td colspan="6" align="center"><strong>'{$centro_name}'
								Patients List</strong></td>
						<td colspan="1" align="center"><a href="/acm/?/study/list"><strong>Home</strong></a></td>
					</tr>
					<tr>
						...
						<td colspan="1" align="center"><a href="/acm/DB_Lock.php?study_prefix={$study_prefix}"><strong>Go
					...
					<tr>
						...
						<td align=middle bgcolor="#00CCFF">Inherit Center's Lock</td>
					</tr>
					...
					{else}
					<tr>
						<td colspan="7" align="center"><strong>Centres</strong></td>
						<td colspan="1" align="center"><a href="/acm/?/study/list"><strong>Home</strong></a></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<a href="?centro={$centro.ID_CENTER}&study_prefix={$study_prefix}"> <img
						...
						<!-- td align=middle class="small"><input type="checkbox" name="{$centro.ID_CENTER}_EQUERY" {if $centro.EQUERY==1} checked = "checked"{/if}></td -->
					</tr>
					{/foreach}
					<tr>
