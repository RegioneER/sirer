...
function date_hide_row(date,rows)
{
    var el=document.forms[0].elements;
	function t()
    {
        if(!elDate(date).equals(MissingDate())) return true;
		return false;
    }    
	o=Object();
	o.checkstate=CP_hideCalendar;
    func_hide_row([el[date+'Y'],el[date+'M'],el[date+'D'],o],t,rows);
	CP_hideCalendar=o.checkstate;
}
