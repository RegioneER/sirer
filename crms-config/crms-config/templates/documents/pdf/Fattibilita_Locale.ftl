...
<#assign datiPromotore=datiPromotore+"<li>"+promotore.titleString+" "+currPromotore.getFieldDataString("datiPromotore","nomePromotore")+"</li>" >
</#if>
</#list>
<#if datiPromotore!= "" >
...
<table>
			...
			<table>
				<tr>
					<td class="txtleft" style="padding-bottom: 10px; padding-top: 20px;">
						...
						<br/><br/> <b>N.B. La compilazione del presente documento &egrave; a cura dello Sperimentatore.</b>
					</td>
				</tr>
			</table>
			<table>
			...
			<table cellspacing="0" style="border-collapse: collapse; border: 0px;">
				...
				<tr>
					<td class="txtleft" style="border: 1px solid black; width: 1000px;" colspan="2">
						Studio profit:
						<#if elStudio.getFieldDataCode("datiStudio","profit")=="1">
						&nbsp;${setCheckbox("datiStudio" "profit" "T" elStudio)}&nbsp; S&igrave;
						&nbsp;${setCheckbox("datiStudio" "profit" "F" elStudio)}&nbsp; No
						<#else>
						&nbsp;${setCheckbox("datiStudio" "profit" "F" elStudio)}&nbsp; S&igrave;
						&nbsp;${setCheckbox("datiStudio" "profit" "T" elStudio)}&nbsp; No
					</#if>
					<br/>
					</td>
				</tr>
				<tr>
					...
					<br/>Solo se no profit:<br/><br/>
						...
						<br/>
						-->
					<br/>No profit Finanziato: <br/><br/>
					<#if elStudio.getFieldDataCode("datiStudio","NoProfitFinanziato")=="1">
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "T" elStudio)}&nbsp; SI<br/><br/>
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "F" elStudio)}&nbsp; NO
					<#elseif elStudio.getFieldDataCode("datiStudio","NoProfitFinanziato")=="2">
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "F" elStudio)}&nbsp; SI<br/><br/>
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "T" elStudio)}&nbsp; NO
					<#else>
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "F" elStudio)}&nbsp; SI<br/><br/>
					&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziato" "F" elStudio)}&nbsp; NO
				</#if>
				...
				<br/>Solo se no profit finanziato:<br/><br/>
				&nbsp;${setCheckbox("datiStudio" "NoProfitFinanziatoTerzi" "1" elStudio)}&nbsp; Con finanziamento da parte di terzi
				<br/>
	...
	<tr>
		<td class="txtleft" style="width:50%;  padding-left:40px;" colspan="2" >
			...
			&nbsp;${setCheckbox("datiStudio" "inUsoDisp" "1" elStudio)}&nbsp; S&igrave;
			&nbsp;${setCheckbox("datiStudio" "inUsoDisp" "2" elStudio)}&nbsp; No
			<br/>
		</td>
	</tr>
</#if>
<#if  elStudio.getFieldDataCode("datiStudio","tipoStudio")=="4">
<tr>
...
<#if  elStudio.getFieldDataCode("datiStudio","tipoStudio")=="5">
<tr>
	<td style="">&nbsp;
...
<tr>
	<td class="txtleft" style="width:50%;  padding-left:40px;" colspan="2">
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "1" elStudio)}&nbsp; case-series
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "2" elStudio)}&nbsp; descrittivo
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "3" elStudio)}&nbsp; studio ecologico
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "4" elStudio)}&nbsp; trasversale (cross-sectional)
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "5" elStudio)}&nbsp; caso-controllo
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "6" elStudio)}&nbsp; di coorte prospettico
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "7" elStudio)}&nbsp; di corte retrospettivo
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "8" elStudio)}&nbsp; di coorte prospettico e retrospettivo
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "9" elStudio)}&nbsp; studio di fattibilit&agrave;
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "10" elStudio)}&nbsp; studio qualitativo
		<br/>
		&nbsp;${setCheckbox("datiStudio" "OSDisegno" "11" elStudio)}&nbsp; longitudinale
		<br/></td>
</tr>
</#if>
<#if  elStudio.getFieldDataCode("datiStudio","tipoStudio")=="6">
<tr>
...
<table cellspacing="0" style="border: 1px solid black; border-collapse: collapse;">
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;"><b>Et&agrave; (STUDIO)</b></td>
	</tr>
	<!--tr>
...
<table cellspacing="0" style="border: 1px solid black; border-collapse: collapse;">
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;"><b>Et&agrave; (CENTRO)</b></td>
	</tr>
	<!--tr>
        <td style="" colspan="2">&nbsp;${setCheckbox("datiStudio" "Sesso" "F" elStudio)}&nbsp; Sesso</td>
    </tr>
	...
	<tr>
		<td class="txtleft" style="width:50%;  padding-left: 40px;" colspan="2">
			...
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "1" el)}&nbsp; In utero
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "2" el)}&nbsp; Neonati pre-termine(fino a un'et&agrave; gestazionale 37 settimane)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "3" el)}&nbsp; Neonati (0-27 giorni)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "4" el)}&nbsp; Lattanti e bambini piccoli (28 giorni-23 mesi)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "5" el)}&nbsp; Bambini (2-11 anni)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "6" el)}&nbsp; Adolescenti (12-17 anni)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "7" el)}&nbsp; Adulti (18-44 anni)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "8" el)}&nbsp; Adulti (45 - 65 anni)
			<br/>
			&nbsp;${setCheckbox("Feasibility" "EtaMin" "9" el)}&nbsp; Anziani (da  65 anni)
			<br/>
		</td>
	</tr>
</table>
...
<table cellspacing="0" style="border: 1px solid black; border-collapse: collapse;">
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;"><b>Arruolamento di "categorie vulnerabili (STUDIO)"</b></td>
	</tr>
	<tr>
		<td class="txtleft" style="width:50%;  padding-left: 40px;" colspan="2">
...
<table cellspacing="0" style="border: 1px solid black; border-collapse: collapse;">
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;"><b>Arruolamento di "categorie vulnerabili (CENTRO)"</b></td>
	</tr>
	<tr>
		<td class="txtleft" style="width:50%;  padding-left: 40px;" colspan="2">
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "7" el)}&nbsp; Per et&agrave;
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "1" el)}&nbsp; Volontari sani
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "2" el)}&nbsp; Pazienti
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "3" el)}&nbsp; Donne in gravidanza e in allattamento
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "5" el)}&nbsp; Pazienti in situazioni di emergenza
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "4" el)}&nbsp; Incapaci di intendere e di volere
			<br/>
			&nbsp;${setCheckbox("Feasibility" "SPTipoPop" "6" el)}&nbsp; Altre categorie vulnerabili  - specificare: ${el.getFieldDataString("Feasibility","PopolazioneVulnerabile")}
			<br/><br/>
			<em>Specificare le modalit&agrave; di arruolamento (dove e come): ${elStudio.getFieldDataString("datiStudio","VolontariSani")}</em>
		</td>
	</tr>
...
<table cellspacing="0" style="border: 1px solid black; border-collapse: collapse;">
	...
	<tr>
		...
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
			${promotore.titleString} ${currPromotore.getFieldDataString("datiPromotore","nomePromotore")}
		</td>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
...
<tr>
	<td class="txtleft" style="border: width:1000px; " colspan="5">
		Specificare a chi &egrave; affidata l'attivit&agrave; di monitoraggio clinico dello studio: ${el.getFieldDataString("Feasibility","monitoraggioChi")}<br/>
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		...
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
			${personale.getFieldDataDecode("DatiTeamDiStudio","UO")}
		</td>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;"><b>*</b> Specificare se medico, infermiere, farmacista, biologo, data manager, etc.
			<br/> <b>**</b> Specificare se dipendente Ospedaliero, dipendente universitario con integrazione assistenziale, medico in formazione, assegnista, libero professionista, dottorando, borsista, etc.</td>
	</tr>
</table>
<br/>
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		...
		<br/>
		Se s&igrave;, compilare di seguito
		</td>
	</tr>
</table>
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		...
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
			${servizio.getFieldDataString("FeasibilitySUO","Servizio")} - ${servizio.getFieldDataDecode("FeasibilitySUO","Struttura")} - ${servizio.getFieldDataDecode("FeasibilitySUO","Dipartimento")} - ${servizio.getFieldDataDecode("FeasibilitySUO","UO")}
		</td>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td class="txtleft" style="width:50%;  padding:4px;">I medicinali sperimentali ed eventualmente i dispositivi usati per somministrarli sono forniti gratuitamente dal promotore dello studio profit; nessun costo aggiuntivo, per la conduzione e la gestione degli studi di cui al presente decreto deve gravare sulla finanza pubblica": decreto legislativo 24.06.2003, n.211 - art. 20, comma 2.
			<br/><br/>Relativamente agli studi no profit finalizzati al miglioramento della pratica clinica ex art. 6 del D.M. 17/12/2004, i farmaci sono a carico del SSN, mentre le eventuali spese aggiuntive, comprese quelle per il farmaco sperimentale, qualora non coperte da fondi di ricerca ad hoc possono gravare sul Fondo della Ricerca di cui all'art. 2, comma 3 del citato Decreto, sempre che si tratti di studi promossi dalla Struttura.
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
			<#assign prodotto=farmaco.getFieldDataDecode("Farmaco","princAtt") />
			<#if farmaco.getFieldDataCode("Farmaco","princAtt")=="-9999">
			<#assign prodotto=farmaco.getFieldDataString("Farmaco","princAttAltro") />
		</#if>
		${prodotto}
		</td>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
...
<table cellspacing="0" style="border-collapse: collapse;">
	<tr>
		<td style="width:50%;  padding-left:10px;"><b>A=</b> a carico del Promotore <i>(specificare la modalit&agrave; - ad es. fornitura diretta, pagamento anticipato, rimborso)</i>
			...
			<br/><b>C=</b> fornitura/finanziamento proveniente da terzi (in tal caso allegare l'accordo tra Promotore e finanziatore terzo che regolamenta la fornitura/il contributo economico) *
			<br/><b>D=</b> a carico del Fondo Aziendale per la Ricerca, ove presente *</td>

	</tr>
	<tr>
		<td style="width:50%;  padding-left:10px;">* Applicabile solo per studi no profit</td>
	</tr>
</table>
<div style="page-break-before: always">&nbsp;</div>
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
			<#assign prodotto=farmaco.getFieldDataDecode("Farmaco","dispMed") />
			<#if farmaco.getFieldDataCode("Farmaco","dispMed")=="-9999">
			<#assign prodotto=farmaco.getFieldDataString("Farmaco","dispMedAltro") />
		</#if>
		${prodotto}
		</td>
		<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
...
<table  cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td class="txtleft" >
			...
			<br/>
			<!-- STSANSVIL-2383: apportate modifiche a seguito della circolare del Ministero della Salute del 25.05.2021 -->
			Presenza del Marchio CE? &nbsp;${setCheckbox("Farmaco" "MarchioCE" "1" farmaco)}&nbsp; S&igrave;	&nbsp;${setCheckbox("Farmaco" "MarchioCE" "2" farmaco)}&nbsp; No
			<ul>
				<li>
					se si, specificare per quali indicazioni: ${farmaco.getFieldDataString("Farmaco","IndicazioniDisp")} <br/>
					In questo caso il Promotore si impegna a comunicare l'avvio dello studio al Ministero della Salute, ai sensi del comma 8 dell'art. 14 del D.Lgs. 46/97 e del comma 7 dell'art. 7 del D.Lgs. 502/92, come da circolare del Ministero della Salute del 25.05.2021
				</li>
				<li>
					se si tratta di indagine PMCF (indagini cliniche Post Market Clinical Follow up) per la valutazione ulteriore della conformit&agrave; di dispositivi medici, utilizzati secondo la destinazione d'uso oggetto della marcatura CE nelle quali i soggetti in studio vengono sottoposti a procedure supplementari invasive o gravose rispetto a quelle eseguite nelle normali condizioni di utilizzazione del dispositivo, il Promotore &egrave; tenuto alla notifica preventiva al Ministero della salute, almeno 30 giorni prima dell'avvio (art. 74.1 Regolamento UE 2017/745, di seguito “Regolamento”, identificato a livello europeo come Medical Device Regulation, di seguito “MDR”).
				</li>
				<li>
					se non in presenza di marchio CE, &egrave; necessario che il Promotore abbia richiesto l'autorizzazione al Ministero della Salute, secondo le procedure indicate sul sito ministeriale a seconda se la richiesta riguardi la validazione e valutazione di una domanda di indagine clinica finalizzata alla dimostrazione della conformit&agrave; di dispositivi medici di classe I o di classe IIa o IIb non invasivi privi di marcatura CE oppure riguardi la validazione e valutazione di una domanda di indagine clinica finalizzata alla dimostrazione della conformit&agrave; di dispositivi medici di classe IIa o IIb invasivi o di classe III privi di marcatura CE (art. 62, par. 1, del Regolamento UE 2017/745, di seguito “Regolamento”, identificato a livello europeo come Medical Device Regulation, di seguito “MDR”). Il medesimo procedimento deve essere seguito quando deve essere condotta un'indagine clinica per valutare un dispositivo che rechi gi&agrave; la marcatura CE ma sia impiegato al di fuori dell'ambito della sua destinazione d'uso (art. 74, par. 2 MDR).
				</li>
			</ul>
			<br/>
			<!-- Impiego secondo destinazione d'uso<br/>
            &nbsp;${setCheckbox("Farmaco" "ImpiegoDestUso" "1" farmaco)}&nbsp; S&igrave;	&nbsp;${setCheckbox("Farmaco" "ImpiegoDestUso" "2" farmaco)}&nbsp; No
            <ul>
            <li>
                se no, &egrave; necessario presentare notifica di indagine clinica al Ministero, secondo quanto previsto dal decreto ministero della salute del 2 agosto 2005 (GU 210 del 9 settembre 2005)
            </li>
            </ul>
            <br/> -->
			...
			Il dispositivo &egrave; gi&agrave; presente in gara di fornitura in Area Vasta?&nbsp;${setCheckbox("depotFarmaco" "GaraFornituraDisp" "1" depotFarmaco)}&nbsp; S&igrave;	&nbsp;${setCheckbox("depotFarmaco" "GaraFornituraDisp" "2" depotFarmaco)}&nbsp; No
			<br/>
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		<td style="width:100%;  padding-left:10px;" colspan="7">Se lo studio prevede l'esecuzione di prestazioni specialistiche aggiuntive rispetto alla pratica clinica (es. ricoveri, visite, esami strumentali o di laboratorio), incluse quelle previste
			...
			<br/> <b>N.B.:</b> come previsto dalle Linee guida per la classificazione e conduzione degli studi osservazionali sui farmaci (Determina AIFA del 20/03/2008), nell'ambito di uno studio osservazionale <i> le procedure diagnostiche e valutative devono
...
<table cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		...
		<td class="txtright" style="border: 1px solid black; width: 1000px; ">
			<#assign tprice=0>
			<#if costoAggiuntivo.getFieldDataString("CostoAggiuntivo","Costo")?? && costoAggiuntivo.getFieldDataString("CostoAggiuntivo","Costo")!="">
...
<table cellspacing="0" style="border-collapse: collapse;">
	<tr>
		<td style="width:50%;  padding-left:10px;">
			...
			<br/><b>B=</b> a carico di fondi della Unit&agrave; Operativa a disposizione dello Sperimentatore*
			<br/><b>C=</b> finanziamento proveniente da terzi (in tal caso allegare l'accordo tra Promotore e finanziatore terzo che regolamenti il contributo economico)
			<br/><b>D=</b> a carico del Fondo Aziendale per la Ricerca, ove presente*
			<br/><b>E=</b> a carico del SSN
		</td>
	</tr>
	<tr>
		<td style="width:50%;  padding-left:10px;">
...
<tr>
	<td class="txtleft" style="border: 1px solid black; width: 1000px; ">
		<b><em>Corrispettivo per le fees aggiuntive se previsto da regolamento del centro (attivit&agrave; amministrative/costi generali o di start-up, fee per il servizio farmaceutico, ecc)</em></b>
	</td>
	<td class="txtright" style="border: 1px solid black; width: 1000px; ">
		<#if profit >
			...
			<table >
				...
				<tr>
					<td>
						...
						-&nbsp;(mantenere unicamente la dichiarazione pertinente tra le due opzioni) lo studio &egrave; coperto da specifica polizza assicurativa oppure non &egrave; necessaria specifica copertura assicurativa in quanto ....................................................................................................................(specificare la motivazione per cui si ritiene non necessaria specifica copertura assicurativa - tale aspetto sar&agrave; comunque oggetto di valutazione da parte del Comitato Etico);<br/>
                        ...
                        -->
						-&nbsp;se studio no profit, (mantenere unicamente la dichiarazione pertinente tra le seguenti opzioni):<br/>
						-&nbsp;non &egrave; previsto alcun finanziamento dedicato per la conduzione dello studio<br/>
						-&nbsp;le modalit&agrave; di impiego del finanziamento dedicato per la conduzione dello studio sono esplicitate nella specifica sezione D del presente documento e <b>nella Nota di disponibilit&agrave; trasmessa dall'Ente erogatore del finanziamento</b><br/>
						-&nbsp;le modalit&agrave; di impiego del finanziamento dedicato per la conduzione dello studio sono esplicitate nella specifica sezione D del presente documento e nel corrispondente accordo finanziario che sar&agrave; stipulato tra .............................................................. e .........................................................;<br/>
