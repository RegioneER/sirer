...
<#global page={
	...
	"styles" : ["jquery-ui-full", "colorpicker", "datepicker","pages/studio.css","x-editable","select2","jstree/themes/default/style.min.css"],
	"scripts" : ["jquery-ui-full","colorpicker", "datepicker","bootbox", "token-input" ,"common/elementEdit.js","x-editable","select2","base","jstree/jstree.min.js"],
	"inline_scripts":[],
	"title" : "Allineamento servizio",
 	"description" : "Allineamento servizio" 
} />
