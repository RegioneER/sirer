<#if layout._topbar_notifications.count gt 0 >
<li class="purple">
	<a data-toggle="dropdown" class="dropdown-toggle" href="#">
		<i class="icon-bell-alt icon-animated-bell"></i>
		<#if layout._topbar_notifications.count gt 0 ><span class="badge badge-important">${layout._topbar_notifications.count}</span></#if>
	</a>
