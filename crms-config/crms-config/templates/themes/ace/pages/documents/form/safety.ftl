...
<@script>
/*var dependency={};
dependency["Safety_ClassificazioneCTCAECategoria"]=["Safety_ClassificazioneCTCAETerm"];
dependency["Safety_ClassificazioneCTCAETerm"]=["Safety_ClassificazioneCTCAEGrado"];*/
