...
$(document).ready(function() {
    $("[name=document-form-submit]").prop("name","document-form-submitCustom").unbind('click');
    $("#document-form-submit").prop("id","document-form-submitCustom");

    $('#document-form-submitCustom').off('click').on('click',function(){
    ...
    if ($('#RiduzioneFattura_QuantitaRiduzione').val()==""){
        ...
        bootbox.alert("Il campo Importo da detrarre deve essere compilato",function(){setTimeout(function(){$input.focus();},0);});
        ...
        if(isNaN($('#RiduzioneFattura_QuantitaRiduzione').val())){
            ...
            bootbox.alert("Il campo Importo da detrarre deve essere numerico",function(){setTimeout(function(){$input.focus();},0);});
            $('#RiduzioneFattura_QuantitaRiduzione').focus();
            return false;
        }
    }
    ...
    if ($('#RiduzioneFattura_TipoRiduzione').val()==""){
        ...
        bootbox.alert("Il campo Riduzione deve essere compilato",function(){setTimeout(function(){$input.focus();},0);});
    ...
    if ($('#RiduzioneFattura_QuandoRecuperare').val()==""){
        ...
        bootbox.alert("Il campo Da recuperare deve essere compilato",function(){setTimeout(function(){$input.focus();},0);});
...
$('#DatiArrPrimoPaz-DatiArrPrimoPaz_dataPrimoArr').hide();
