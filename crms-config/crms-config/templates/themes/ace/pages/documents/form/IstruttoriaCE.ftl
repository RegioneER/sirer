...
<@script>
	...
	$('#document-form-submit').ready(function() {
		...
		$('#IstruttoriaCE-IstruttoriaCE_CompletezzaDt').hide();
		//$('#IstruttoriaCE-IstruttoriaCE_Note').hide();
		$('#IstruttoriaCE-IstruttoriaCE_IntegrazioniDt').hide();
		//$('#IstruttoriaCE-IstruttoriaCE_RichIntegr').hide();
		$('#IstruttoriaCE-IstruttoriaCE_RiapriSoloDoc').hide();
	});
	...
	$("[name=IstruttoriaCE_DocCompleta]").on('change',function(){
		...
		if($('#IstruttoriaCE_DocCompleta:checked').val()!==undefined && $('#IstruttoriaCE_DocCompleta:checked').val().split("###")[0]==1){
			$('#IstruttoriaCE-IstruttoriaCE_CompletezzaDt').show();
			//$('#IstruttoriaCE-IstruttoriaCE_Note').show();
			$('#IstruttoriaCE-IstruttoriaCE_IntegrazioniDt').hide();
			...
			$('#IstruttoriaCE-IstruttoriaCE_IntegrazioniDt').show();
			$('#IstruttoriaCE-IstruttoriaCE_RichIntegr').show();
			$('#IstruttoriaCE-IstruttoriaCE_RiapriSoloDoc').show();
		}
		else {
			$('#IstruttoriaCE-IstruttoriaCE_CompletezzaDt').hide();
			$('[id=IstruttoriaCE_CompletezzaDt]').val('');//se nascondo sbianco il valore!
  ...
  $.ajax({
      ...
      success: function(obj){
          if (obj.result=="OK") {
              ...
              if (obj.redirect){
                  window.location.href="${baseUrl}/app/documents/detail/"+parentId+"#IstruttoriaCE-tab2";
              }
          }else {
			bootbox.hideAll();
