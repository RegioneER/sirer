...
<@script>
//TOSCANA-168 vmazzeo 19.06.2017
 	$( document ).ready(function() {
 		/*$('#DocCentroSpec_TipoDocumento-select option').each(function(){
 			var my_code=$(this).val().split("###");
 			if(my_code[0]==5||my_code[0]==6||my_code[0]==16){
