...
<#assign budget=budgetStudio.getParent().getParent() />
<#assign center=budget.getParent() />
...
<#assign elType= el.type />
 ...
 <div class="row">
  ...
  Pace.on('stop', function(){
    var mybutton=$('button.third');
    $('button.second').before(mybutton);
  });
 </@script>
       ...
       <#assign currTabContent>
	        ...
	        <div id="added-costs-4" class="ui-widget cost-table">
	            <fieldset> <legend>Costi aggiuntivi per studio</legend>
        ...
        <!--div id="added-costs-2" class="ui-widget cost-table">
            <legend>Costi aggiuntivi per studio:</legend>
        ...
        <div id="added-ca"  class="ui-widget  ">
            <legend>Costi aggiuntivi:</legend>
            <table id="added-ca-table" class="table table-striped table-bordered table-hover">
            <thead>
            <tr >
            <th>Tipologia</th>
            <th>Descrizione</th>
            ...
            <div id="dialog-form-CTC" title="Aggiungi overhead aziendale">
           	...
           	<div id="dialog-form-cost-2" title="Aggiungi costo non clinico">
                ...
                <select  name="tipologia" id="tipologia2" class="text ui-widget-content ui-corner-all" onchange="changeTipologia();" />
                ...
                <label for="Prestazioni_prestazione">Descrizione<span class="red">*</span></label>
                ...
                <label for="Prestazioni_CDC">Competenza<span class="red">*</span></label>
                ...
                <label for="Costo_Copertura">Copertura<span class="red">*</span></label>
                ...
                <label for="markup-costo2">Overhead</label>
                ...
                <input type="hidden" id="Tariffario_SSN" name="Tariffario_SSN" value="" class="text ui-widget-content ui-corner-all" />
                <input type="hidden" id="Prestazioni_Codice" name="Prestazioni_Codice" value="" class="text ui-widget-content ui-corner-all" />
        ...
        //form dei costi
         var myForm3Renderer = function (instance, td, row, col, prop, value, cellProperties) {
            ...
            var myContent=$.axmr.label(value,2);
   			...
   			var colOcc=($('#costi').handsontable('getDataAtCell',0,col)=='Totale occorrenze' || rowText =='TP/Proposta promotore');
           	if(myContent && !colOcc){
          ...
          function valorizzaCDC(cdc,item){
           ...
           $( "#Prestazioni_prestazione" ).autocomplete({
				...
				select: function( event, ui ) {
							...
							$('#costo2').val($.trim(ui.item.ssn).replace(/,/,'.')).trigger('change');
