...
<div id="tabs-4" class="tab-pane">
        ...
        <div style="float:right">
         <div id="dialog-form-prezzo" title="Aggiungi prezzo finale">
            ...
            <button id="create-cost-2" class="submitButton round-button blue templateForm btn btn-info" >
			<i class="icon-plus bigger-160"></i>
			<b> Costo non clinico</b>
			</button>
        ...
        <div id="added-ca" style="min-width:500px;" class="ui-widget cost-table">
            ...
            <tbody>
                <tr>
            <td colspan=5><span class="help-button">?</span> Tabella riassuntiva dei costi aggiuntivi </td>
