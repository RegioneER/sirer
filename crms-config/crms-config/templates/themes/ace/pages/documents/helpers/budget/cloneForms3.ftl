...
<div id="clone2-dialog-form" title="Copia budget">
    ...
    <label for="SingoloBraccio_Braccio">Braccio</label>
    <input type="text" name="SingoloBraccio_Braccio" id="SingoloBraccio_Braccio" cols="100" rows="6"  class="text ui-widget-content ui-corner-all"></textarea>
