...
<#include "../helpers/MetadataTemplate.ftl"/>
 <div class="row">
   		...
   		<button class="btn btn-warning" id="Salva"  onclick="saveAll();"><i class="icon-save bigger-160"></i> <b>Salva</b></button><#--include "../helpers/budget/bracciForm.ftl"/-->
    ...
    <div style="display: block">
		...
		<#include "../helpers/budget/tabellaVersioniStudio.ftl"/>
			<#include "../helpers/budget/tabClinicoView.ftl"/>
        </div>
        </div>
