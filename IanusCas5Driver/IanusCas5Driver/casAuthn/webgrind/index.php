...
Webgrind_Config::$storageDir = $_SERVER['DOCUMENT_ROOT'].'/../xdebug-profile-logs';
Webgrind_Config::$profilerDir = $_SERVER['DOCUMENT_ROOT'].'/../xdebug-profile-logs';

if (isset($_GET['clearOld'])){
	system("rm ".$_SERVER['DOCUMENT_ROOT'].'/../xdebug-profile-logs/*');
