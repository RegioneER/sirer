        ...
        try (Connection conn = dataSource.getConnection()) {
            try (PreparedStatement stmt = conn.prepareStatement(sqlQuery1)) {
                try (ResultSet rset = stmt.executeQuery()) {
                    ...
                    hibTablesList.add("DOC_ACL");
                    hibTablesList.add("DOC_ACL_CONTAINER");
                    ...
                    hibTablesList.add("DOC_COMMENT");
                    hibTablesList.add("DOC_EL_PROCESS");
                    hibTablesList.add("DOC_EVENTS");
                    hibTablesList.add("DOC_MD_FIELD");
                    hibTablesList.add("DOC_MD_TEMPLATE");
                    hibTablesList.add("DOC_OBJ_FILE");
                    hibTablesList.add("DOC_OBJ_FILE_CONTENT");
                    hibTablesList.add("DOC_OBJ_GROUP");
                    hibTablesList.add("DOC_OBJ_MD");
                    hibTablesList.add("DOC_OBJ_MD_VAL");
                    hibTablesList.add("DOC_OBJ_TEMPLATE");
                    hibTablesList.add("DOC_POLICY");
                    hibTablesList.add("DOC_TPL_ACL");
                    hibTablesList.add("DOC_TPL_ACL_CONTAINER");
                    hibTablesList.add("DOC_TYPE");
                    hibTablesList.add("DOC_TYPE_MD_TEMPLATE");
                    hibTablesList.add("DOC_TYPE_WF");
                    while (rset.next()) {
                        ...
                        if (hibTablesList.contains(table_name)) {
                            ...
                            hibernateMaxValQuery += "select max(id) as id from " + table_name + "\n";
                        }
                    }
