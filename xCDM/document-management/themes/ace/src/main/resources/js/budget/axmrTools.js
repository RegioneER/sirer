...
(function ($, window) {
    ...
    $.axmr.setUpdated=function(incoming){
    	var obj;
    	if($.isPlainObject(incoming) || $.isArray(incoming)){
    		obj=incoming;
    	}
    	else{
    		obj=elements[incoming];
    	}
    	obj.updateCheck=1;
    	updatedElements[obj.guid]=true;
    	$(".warning").html("Attenzione, le modifiche effettuate saranno valide solo dopo aver salvato i dati").show();
    	return obj;
    };
