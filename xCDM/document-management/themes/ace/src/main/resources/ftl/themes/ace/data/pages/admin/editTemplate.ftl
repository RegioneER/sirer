...
<@script>
         ...
         $('#field-form #type').change(function(){
             if ($(this).val()=='ELEMENT_LINK' || $(this).val()=='PLACE_HOLDER') {
             ...
             if ($(this).val()=='SELECT' || $(this).val()=='CHECKBOX' || $(this).val()=='RADIO' || $(this).val()=='ELEMENT_LINK' || $(this).val()=='PLACE_HOLDER'){
             ...
             if ($(this).val()=='EXT_DICTIONARY' || $(this).val()=='ELEMENT_LINK' || $(this).val()=='PLACE_HOLDER'){
     ...
     function fieldPostClear(){
      if ($('#field-form #type').val()=='ELEMENT_LINK' || $('#field-form #type').val()=='PLACE_HOLDER') {
             	$('#multiTypeSelector').show();
             	$('[for="multiTypeSelector"]').show();
             }
             else {
             ...
             if ($('#field-form #type').val()=='SELECT' || $('#field-form #type').val()=='CHECKBOX' || $('#field-form #type').val()=='RADIO' || $('#field-form #type').val()=='ELEMENT_LINK' || $('#field-form #type').val()=='PLACE_HOLDER'){
             	$('#availableValues').show();
             	$('[for="availableValues"]').show();
             	$('#addFilterFields').show();
             	$('[for="addFilterFields"]').show();
             ...
             if ($('#field-form #type').val()=='EXT_DICTIONARY' || $('#field-form #type').val()=='ELEMENT_LINK' || $('#field-form #type').val()=='PLACE_HOLDER'){
             	$('#externalDictionary').show();
             	$('[for="externalDictionary"]').show();
             	$('#addFilterFields').show();
             	$('[for="addFilterFields"]').show();
