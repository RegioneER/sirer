...
<fieldset style="width:60%">
	...
	<#if el.file??>
	<h3 class="metadata-template-title">Informazioni file</h3>
        <div class="field-component view-mode">
        <label for="autore">Autore:</label><b>${el.file.autore!""}</b>
        </div>
        <div class="field-component view-mode">
        <label>Versione:</label><b>${el.file.version!""}</b>
        <#if el.file.date??>
        </div>
        <div class="field-component view-mode">
        <label>Data:</label><b>${el.file.date.time?datetime?string.full}</b>
        </div>
        </#if>
        
        <div class="field-component view-mode">
        <label>Note:</label><b>${el.file.note!""}</b>
        </div>
        <br/>
       </#if>
