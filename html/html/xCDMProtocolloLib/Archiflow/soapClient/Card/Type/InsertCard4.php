...
class InsertCard4 implements RequestInterface
{
     ...
     */
    public function __construct($strSessionId, $oCard, $oUsers, $oGroups, $oOffices, $strNote, $strMessage, $bIsAutomaticProtocol, $bVisOnlyDoc, $bVisAllNote, $bSorted, $oClassFolderList, $bAutoCheckIn)
    {
