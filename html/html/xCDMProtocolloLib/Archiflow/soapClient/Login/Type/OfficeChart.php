...
class OfficeChart implements RequestInterface
{
    ...
    /**
     * @var \ArchiflowWSLogin\Type\ArrayOfint
     */
     ...
     * Constructor
     *
     * @var \ArchiflowWSLogin\Type\ArrayOfint $ChildrenOfficesIds
     * @var int $Code
    ...
    /**
     * @return \ArchiflowWSLogin\Type\ArrayOfint
     */
    ...
    /**
     * @param \ArchiflowWSLogin\Type\ArrayOfint $ChildrenOfficesIds
     * @return OfficeChart
     */
