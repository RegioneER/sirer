...
class LeggiDocumentoString implements RequestInterface
{
     ...
     */
    public function __construct($IdDocumento, $Utente, $Ruolo, $CodiceAmministrazione, $CodiceAOO)
    {
