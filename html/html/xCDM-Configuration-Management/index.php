...
switch($_GET['orig']){
    ...
    case 'prep':
        ...
        $_SERVER['DOCUMENT_ROOT']="/http/servizi/siss-bundle-01/sirer-test.sissprep.cineca.it/html";//"/sissprep".$_SERVER['DOCUMENT_ROOT'];
        $conn1=new dbconn();
...
switch($_GET['dest']){
    ...
    case 'prep':
        $origDocRoot=$_SERVER['DOCUMENT_ROOT'];
        $_SERVER['DOCUMENT_ROOT']="/http/servizi/siss-bundle-01/sirer-ctms.sissprep.cineca.it/html";//"/sissprep".$_SERVER['DOCUMENT_ROOT'];
        $conn2=new dbconn();
        $_SERVER['DOCUMENT_ROOT']=$origDocRoot;
        break;
    case 'prod':
