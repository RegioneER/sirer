...
function TipoStudio (cellvalue){
	if(cellvalue && cellvalue!=null && cellvalue!='') return cellvalue[0].split("###")[1];
	else return "";
}

function getDecode (cellvalue){
    if(cellvalue && cellvalue!=null && cellvalue!='') return cellvalue[0].split("###")[1];
    else return cellvalue;
}

function descrStudio(studio){
	return studio.IDstudio_CodiceProt+' ('+studio.UniqueIdStudio_id+' '+TipoStudio(studio.datiStudio_Profit)+')';
}
