...
class CardBundle implements RequestInterface
{
     ...
     */
    public function setDocStatus(string $DocStatus)
    {
     ...
     * @param ProcWF $ProcWF
     */
    public function setProcWF(string $ProcWF)
    {
        $this->ProcWF = $ProcWF;
    }
    ...
    /**
     * @var \ArchiflowWSCard\Type\ArrayOfKeyValueOfintArrayOfintty7Ep6D1
     */
    ...
    /**
     * @var \ArchiflowWSCard\Type\ProtocolMainDocType
     */
    private $ProtocolMainDocType = null;

    /**
     * Constructor
     *
     * @var \ArchiflowWSCard\Type\ArrayOfAgrafCard $AgrafCards
     * @var \ArchiflowWSCard\Type\ArrayOfAnnotation $Annotations
     * @var \ArchiflowWSCard\Type\ArrayOfAttachment $Attachments
     * @var \ArchiflowWSCard\Type\ArrayOfKeyValueOfintArrayOfintty7Ep6D1 $ClassFolder
     * @var \ArchiflowWSCard\Type\ArrayOfClassificationFolder $ClassFolderList
     * @var \ArchiflowWSCard\Type\ArrayOfHistory $History
     * @var \ArchiflowWSCard\Type\Document $MainDocument
     * @var \ArchiflowWSCard\Type\ProtocolMainDocType $ProtocolMainDocType
     */
    public function __construct($AgrafCards, $Annotations, $Attachments, $ClassFolder, $ClassFolderList, $History, $MainDocument, $ProtocolMainDocType)
    {
        $this->AgrafCards = $AgrafCards;
        $this->Annotations = $Annotations;
        $this->Attachments = $Attachments;
        $this->ClassFolder = $ClassFolder;
        $this->ClassFolderList = $ClassFolderList;
        $this->History = $History;
        $this->MainDocument = $MainDocument;
        $this->ProtocolMainDocType = $ProtocolMainDocType;
    }
    ...
    /**
     * @param \ArchiflowWSCard\Type\ArrayOfAnnotation $Annotations
     * @return CardBundle
     */
    ...
    /**
     * @param \ArchiflowWSCard\Type\ArrayOfAttachment $Attachments
     * @return CardBundle
     */
    ...
    /**
     * @return \ArchiflowWSCard\Type\ArrayOfKeyValueOfintArrayOfintty7Ep6D1
     */
    ...
    /**
     * @param \ArchiflowWSCard\Type\ArrayOfKeyValueOfintArrayOfintty7Ep6D1 $ClassFolder
     * @return CardBundle
     */
    public function withClassFolder($ClassFolder)
    {
        $new = clone $this;
        $new->ClassFolder = $ClassFolder;
     ...
     */
    public function getClassFolderList()
    {
        return $this->ClassFolderList;
    }

    /**
     * @param \ArchiflowWSCard\Type\ArrayOfClassificationFolder $ClassFolderList
     * @return CardBundle
     */
    public function withClassFolderList($ClassFolderList)
    {
        $new = clone $this;
        $new->ClassFolderList = $ClassFolderList;
    ...
    /**
     * @param \ArchiflowWSCard\Type\ArrayOfHistory $History
     * @return CardBundle
     */
    ...
    /**
     * @param \ArchiflowWSCard\Type\Document $MainDocument
     * @return CardBundle
     */
    ...
    /**
     * @return \ArchiflowWSCard\Type\ProtocolMainDocType
     */
    public function getProtocolMainDocType()
    {
        return $this->ProtocolMainDocType;
    }

    /**
     * @param \ArchiflowWSCard\Type\ProtocolMainDocType $ProtocolMainDocType
     * @return CardBundle
     */
    public function withProtocolMainDocType($ProtocolMainDocType)
    {
        $new = clone $this;
        $new->ProtocolMainDocType = $ProtocolMainDocType;
