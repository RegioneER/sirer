...
class ArchiflowServiceExceptionDetail implements RequestInterface
{
    ...
    /**
     * @var \ArchiflowWSFolder\Type\ArchiflowExceptionSeverity
     */
     ...
     * @var string $Message
     * @var string $Name
     * @var \ArchiflowWSFolder\Type\ArchiflowExceptionSeverity $Severity
     */
    ...
    /**
     * @return \ArchiflowWSFolder\Type\ArchiflowExceptionSeverity
     */
    ...
    /**
     * @param \ArchiflowWSFolder\Type\ArchiflowExceptionSeverity $Severity
     * @return ArchiflowServiceExceptionDetail
     */
