...
class ArchiflowServiceExceptionDetail implements RequestInterface
{
    ...
    /**
     * @var \ArchiflowWSLogin\Type\ArchiflowExceptionSeverity
     */
     ...
     * @var string $Message
     * @var string $Name
     * @var \ArchiflowWSLogin\Type\ArchiflowExceptionSeverity $Severity
     */
    ...
    /**
     * @return \ArchiflowWSLogin\Type\ArchiflowExceptionSeverity
     */
    ...
    /**
     * @param \ArchiflowWSLogin\Type\ArchiflowExceptionSeverity $Severity
     * @return ArchiflowServiceExceptionDetail
     */
