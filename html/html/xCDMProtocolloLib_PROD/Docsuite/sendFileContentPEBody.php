...
if ($argv && count($argv)>5) {
    ...
    //$filePath = $argv[8];
    //$fileMimeType = $argv[9];
    $fileContent = file_get_contents($argv[9]);
    $fileName = $argv[8];
}else{
    $data = $_POST;
...
$protocolXML.="<Name>Vincenzo</Name>";
$protocolXML.="<Surname>Mazzeo</Surname>";
$protocolXML.="</Contact>";
...
$base64DocStream = str_replace(" ","+",$base64DocStream);
//die($base64DocStream);
