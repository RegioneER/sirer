...
<style>
	...
	<div class=\"well well-sm\" style=\"margin-bottom: 0px;\">
		<table border=0 cellpadding=0 cellspacing=0 >
			<tr>
				<td align='left'>Cerca CRO: &nbsp;&nbsp;</td>
				<td><input style=\"width: 297px;\" type='text' name='PATTERN' value='{$_POST['PATTERN']}' placeholder=\"CRO\"></td>
			</tr>
			<tr>
				<td colspan=2 align='center'>
					...
					<button title=\"Cerca CRO in Banca Dati\" id=\"button-search\" class=\"btn btn-purple btn-sm\" type=\"submit\" onclick=\"document.forms['cerca_form'].Page.value=1\">
...
if (isset ( $_POST ['Cerca'] )) {
	if ($_POST ['PATTERN'] != '') {
		...
		$sql_query="select * from CE_ELENCO_CRO $sql_where_clause";
		 //echo "$sql_query";
		$sql=new query($conn);
		$sql->exec($sql_query);
			...
			$body.="
					<tr>
						...
						<th style=\"text-align:center;\" >
						  <button title=\"Inserisci CRO allo studio\" id=\"button-search\" class=\"btn btn-purple btn-sm\" type=\"submit\" onclick=\"".make_button_link($sql->row)."\">
