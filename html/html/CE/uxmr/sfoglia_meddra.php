...
if ($_GET['MODE']=='SFOGLIA'){
	$action_link="sfoglia_meddra.php?MODE=SFOGLIA&L1=PATOLOGIAL1&L2=PATOLOGIAL2&L3=PATOLOGIAL3&L4=PATOLOGIAL4&L5=PATOLOGIAL5&DL1=D_PATOLOGIAL1&DL2=D_PATOLOGIAL2&DL3=D_PATOLOGIAL3&DL4=D_PATOLOGIAL4&DL5=D_PATOLOGIAL5";
...
if ($_GET['MODE']=='CERCA'){
	$action_link="sfoglia_meddra.php?MODE=CERCA&L1=PATOLOGIAL1&L2=PATOLOGIAL2&L3=PATOLOGIAL3&L4=PATOLOGIAL4&L5=PATOLOGIAL5&DL1=D_PATOLOGIAL1&DL2=D_PATOLOGIAL2&DL3=D_PATOLOGIAL3&DL4=D_PATOLOGIAL4&DL5=D_PATOLOGIAL5";
	...
	if (isset($_POST['cerca'])){
		...
		foreach ($query as $key => $val){
			...
			//echo $keyword;
			//die();
			$query_sql="select * from ($val) where (upper(DECODIFICA) like '%".$keyword."%' or upper(CODICE) like '%".$keyword."%')";
	...
	function make_form($idx, $action_link, $sfoglia=true){
		...
		<form method='POST' name='sfoglia_form_$idx' action=\"$action_link\">
			Inserire parte del codice o della descrizione: <input type='text' name='PATTERN' value=\"{$_POST['PATTERN']}\">
	...
	function tabella_risultati($idx, $sql_query, $conn){
		...
		while ($sql->get_row()){
			...
			/*
			echo "COD_LIVELLO_SOC".$sql->row['COD_LIVELLO_SOC']."<br>";
			echo "COD_LIVELLO_HLGT".$sql->row['COD_LIVELLO_HLGT']."<br>";
			echo "COD_LIVELLO_HLT".$sql->row['COD_LIVELLO_HLT']."<br>";
			echo "COD_LIVELLO_PT".$sql->row['COD_LIVELLO_PT']."<br>";
			echo "LIVELLO_".$sql->row['LIVELLO_']."<br>";
			echo "CODICE".$sql->row['CODICE']."<br>";
			echo "DECODIFICA".$sql->row['DECODIFICA']."<br><br>";
			*/
