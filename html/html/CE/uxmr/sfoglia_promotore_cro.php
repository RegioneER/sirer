...
<style>
	...
	<div class=\"well well-sm\" style=\"margin-bottom: 0px;\">
		<table border=0 cellpadding=0 cellspacing=0 >
			<tr>
				<td align='left'>Cerca Promotore/CRO: &nbsp;&nbsp;</td>
				<td><input style=\"width: 297px;\" type='text' name='PATTERN' value='{$_POST['PATTERN']}' placeholder=\"Promotore o CRO\"></td>
			</tr>
			<tr>
				<td colspan=2 align='center'>
					...
					<button title=\"Cerca Promotore/CRO in Banca Dati\" id=\"button-search\" class=\"btn btn-purple btn-sm\" type=\"submit\" onclick=\"document.forms['cerca_form'].Page.value=1\">
...
if (isset ( $_POST ['Cerca'] )) {
	if ($_POST ['PATTERN'] != '') {
		...
		$sql_query="select * from CE_ELENCO_PROMOTORI_CRO $sql_where_clause";
		 //echo "$sql_query";
		$sql=new query($conn);
		$sql->exec($sql_query);
		...
		$body.="
			<table class=\"table table-striped table-bordered table-hover\" width=\"95%\" border=\"0\" align=\"center\">
				<thead>
					<tr>
						<th>Denominazione Sponsor/CRO</th>
			...
			$body.="
					<tr>
						...
						<th style=\"text-align:center;\" >
							<button title=\"Inserisci Sponsor/CRO allo studio\" id=\"button-search\" class=\"btn btn-purple btn-sm\" type=\"submit\" onclick=\"".make_button_link($sql->row)."\">
