...
newWindow: function(options){
    ...
    setFocus($window);
    $window.fadeIn();
    $("#opacity_div").css("display", "");
   	$("#opacity_div").css("background", "#000000");
   	$("#opacity_div").css("opacity", "0.5");
   	$("#opacity_div").css("position", "absolute");
	$("#opacity_div").css("zIndex", "5"); 
   	$("#opacity_div").css("width", "100%"); 
//   	$("#opacity_div").css("height", $("body").css("height"));
   	$("#opacity_div").css("height", $(document).height()+0);
   	$("#opacity_div").css("top", "0"); 
   	$("#opacity_div").css("left", "0"); 
