<?php
    ...
    if($_POST['new']){
        ...
        $select="select distinct codice,substr(codice||' - '||prestazione,1,100) as PRESTAZIONE,tariffa_ssn,TARIFFA from EXT_PRESTAZIONI where lower(prestazione) like '%'||lower(:term)||'%'";
